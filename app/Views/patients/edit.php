<h1>Edit Patient Lead #<?= e($patient['id'] ?? '') ?></h1>
...
<div class="form-group">
    ...
    <div class="form-actions"><button class="button" type="submit">Update</button><a class="button secondary" href="/patients">Back</a></div>
</form>
<br>
<form method="POST" action="/patients/delete" onsubmit="return confirm('Xóa hồ sơ này?')">
    <?= csrf_field() ?>
    <input type="hidden" name="id" value="<?= e($patient['id'] ?? '') ?>">
